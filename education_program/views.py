...
def list_institutions(request):
    institutions = Institution.objects.filter(education_program_institution__institution__isnull=False).order_by("name").distinct()
...
def list_professors(request):
    professors = Professor.objects.filter(education_program_professor__isnull=False).order_by("name").distinct()
